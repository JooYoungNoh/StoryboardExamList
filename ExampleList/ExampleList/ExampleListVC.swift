...
class ExampleListVC: UIViewController {
    ...
    private var examList: [String] = ["InteractionExamVC", "AutoLayoutOneVC", "AutoLayoutTwoVC", "AutoLayoutThreeVC", "AutoLayoutFourVC", "AutoLayoutFiveVC", "AutoLayoutSixVC", "CrossVC", "EventVC", "TabPracticeVC", "CustomTabBar", "TablePracticeVC", "UIKitAndSwiftUIVC", "UseImagePickerVC"]
